...
public class area_cal extends AppCompatActivity {
    ...
    AreaConversions areaConversions = new AreaConversions();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_fromUnit.setText(areaConversions.values[0]);
        tv_toUnit.setText(areaConversions.values[1]);
        ...
        cv_toUnit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String[] flowers = areaConversions.values;
