...
public class freq_cal extends AppCompatActivity {
    ...
    FrequencyConversions frequencyConversions = new FrequencyConversions();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_fromUnit.setText(frequencyConversions.values[0]);
        tv_toUnit.setText(frequencyConversions.values[1]);
        ...
        cv_toUnit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String[] flowers = frequencyConversions.values;
