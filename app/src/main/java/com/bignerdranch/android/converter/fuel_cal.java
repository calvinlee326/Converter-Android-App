...
public class fuel_cal extends AppCompatActivity {
    ...
    FuelConversions fuelConversions = new FuelConversions();
    ...
    String fromUnit = fuelConversions.values[0];
    String toUnit = fuelConversions.values[1];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fuel_cal);
        ...
        tv_fromUnit.setText(fuelConversions.values[0]);
        tv_toUnit.setText(fuelConversions.values[1]);
        ...
        cv_convert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tempInput.equals("") || tempInput == null) {
                    ...
                    for (Conversion c : fuelConversions.conversions) {
        ...
        cv_toUnit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String[] flowers = fuelConversions.values;
