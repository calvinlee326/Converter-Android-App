...
public class length_cal extends AppCompatActivity {
    ...
    String fromUnit = lengthConversions.values[0];
    String toUnit = lengthConversions.values[1];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_fromUnit.setText(lengthConversions.values[0]);
        tv_toUnit.setText(lengthConversions.values[1]);
        ...
        cv_convert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tempInput.equals("") || tempInput == null) {
                    ...
                    for (Conversion c : lengthConversions.conversions) {
        ...
        cv_toUnit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String[] flowers = lengthConversions.values;
