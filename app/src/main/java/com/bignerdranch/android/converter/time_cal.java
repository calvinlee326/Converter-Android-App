...
public class time_cal extends AppCompatActivity {
    ...
    String fromUnit = timeConversions.values[0];
    String toUnit = timeConversions.values[1];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_fromUnit.setText(timeConversions.values[0]);
        tv_toUnit.setText(timeConversions.values[1]);
        ...
        cv_convert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tempInput.equals("") || tempInput == null) {
                    ...
                    for (Conversion c : timeConversions.conversions) {
        ...
        cv_toUnit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String[] flowers = timeConversions.values;
