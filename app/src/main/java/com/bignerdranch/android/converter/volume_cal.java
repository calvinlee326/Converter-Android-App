...
public class volume_cal extends AppCompatActivity {
    ...
    String fromUnit = volumeConversions.values[0];
    String toUnit = volumeConversions.values[1];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_fromUnit.setText(volumeConversions.values[0]);
        tv_toUnit.setText(volumeConversions.values[1]);
        ...
        cv_convert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tempInput.equals("") || tempInput == null) {
                    ...
                    for (Conversion c : volumeConversions.conversions) {
        ...
        cv_toUnit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String[] flowers = volumeConversions.values;
